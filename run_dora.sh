...
python run_dora.py \
    ...
    --adapter_name 'dora' --output_dir 'ini_model_dora_gpt2-xl_250326' \
    --batch_size 32  --micro_batch_size 32 --num_epochs 1 \
    --learning_rate 2e-4 --weight_decay 0.0 \
    --use_gradient_checkpointing False --val_set_size 120 \
    --eval_step 160 --save_step 160 --cutoff_len 256 \
